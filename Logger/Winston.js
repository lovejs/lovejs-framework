...
winston.format.emojify = require("./formatters/emojify");
winston.format.stylify = require("./formatters/stylify");
winston.format.errorstack = require("./formatters/errorstack");
